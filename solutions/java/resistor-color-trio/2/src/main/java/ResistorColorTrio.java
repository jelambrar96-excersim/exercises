class ResistorColorTrio {
    ...
    String label(String[] colors) {
        ...
        if (resistence > 10e9) {
            return String.format("%.1f gigaohms", (double)resistence / 10e9);
        }
        if (resistence > 10e6) {
            return String.format("%.1f megaohms", (double)resistence / 10e6);
        }
        else if ( resistence > 10e3) {
            return String.format("%.1f kiloohms", (double)resistence / 10e3);
        }
