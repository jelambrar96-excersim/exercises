...
class TwelveDays {
    ...
    private static String [] versesTable;

    static {

        versesTable = new String[] {
    ...
    String verse(int verseNumber) {
        return versesTable[verseNumber - 1] + "\n";
    }

    String verses(int startVerse, int endVerse) {
        return Arrays.stream(Arrays.copyOfRange(versesTable, startVerse - 1, endVerse))
