...
public class IntergalacticTransmission {
    ...
    public static void main(String[] args) {
        // Example usage
        List<Integer> message = List.of(0xc0, 0x01, 0x13, 0x37, 0xc0, 0xde, 0x21, 0x21);
        List<Integer> transmitted = getTransmitSequence(message);
        System.out.println("Transmitted: " + transmitted);

        List<Integer> decoded = decodeSequence(transmitted);
